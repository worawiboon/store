...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<TmpOrderDetail> TmpOrderDetails { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-5OGFFKR;Database=northwind;User Id=sa;Password=1234;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("check_order_m"));
        ...
        modelBuilder.Entity<TmpOrderDetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tmp_OrderDetails", tb =>
                {
                    tb.HasTrigger("Del_tmporderdetails");
                    tb.HasTrigger("InsUp_tmporderdetails");
                });
        ...
        modelBuilder.Entity<TmpProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tmp_Products", tb => tb.HasTrigger("check_price"));
